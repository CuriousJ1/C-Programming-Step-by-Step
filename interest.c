...
int main(){
	...
	printf("Input the duration in years: ");
	scanf("%d", &duration);
	...
	//	
	total_interest = (rate * principal_amount * duration);

	printf("Your total payable interest is $%f, when principal_amount given as %lf, duration is %d", total_interest, principal_amount, duration);
